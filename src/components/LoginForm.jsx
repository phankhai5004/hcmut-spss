...
function LoginForm() {
  return (
    <div className="flex h-full w-full truncate bg-white p-[12px]">
      ...
      <div className="flex flex-1 items-center justify-center overflow-hidden rounded-xl bg-[#e9ecef]">
        <img className="h-screen w-full object-cover" src="src/assets/thu_vien_bk.png" alt="University Building" />
      </div>
    </div>
  );
}
